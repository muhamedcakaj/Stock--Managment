    ...
    >
      ...
      >
        ...
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "1.5rem" }}>
          ...
          <button
            onClick={onClose}
            style={{ background: "#EDEBE7", border: "none", borderRadius: "50%", width: 32, height: 32, cursor: "pointer", color: "#78716C", fontSize: "1.1rem", display: "flex", alignItems: "center", justifyContent: "center" }}
          >×</button>
        </div>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: "1rem" }}>
          ...
          {/* Location — read-only display, always Magazine */}
          <div>
        ...
        <div style={{ display: "flex", gap: "0.75rem", marginTop: "1.5rem" }}>
          <button
            onClick={onClose}
            style={{ flex: 1, padding: "0.8rem", borderRadius: "0.85rem", border: "1.5px solid #E7E5E0", background: "#fff", color: "#78716C", fontFamily: "'DM Sans', sans-serif", fontWeight: 600, fontSize: "0.9rem", cursor: "pointer" }}
          >Cancel</button>
          <button
            onClick={handleSubmit}
            disabled={busy}
            style={{ flex: 1, padding: "0.8rem", borderRadius: "0.85rem", border: "none", background: busy ? "#D6D3D1" : "#1C1917", color: "#fff", fontFamily: "'DM Sans', sans-serif", fontWeight: 700, fontSize: "0.9rem", cursor: busy ? "not-allowed" : "pointer", transition: "background 0.15s" }}
          >{busy ? "Saving…" : isEdit ? "Update" : "Add Item"}</button>
        </div>
      </div>
    </div>
  );
  ...
  return (
    <div style={{ background: "#fff", border: "1.5px solid #F0EDE8", borderRadius: "1rem", padding: "1rem 1.1rem", display: "flex", alignItems: "center", gap: "0.9rem", boxShadow: "0 1px 4px rgba(0,0,0,0.04)" }}>
      ...
      <div style={{ flex: 1, minWidth: 0 }}>
        <p style={{ fontFamily: "'DM Sans', sans-serif", fontWeight: 600, fontSize: "0.95rem", color: "#1C1917", margin: 0, whiteSpace: "nowrap", overflow: "hidden", textOverflow: "ellipsis" }}>
          {stock.name}
        </p>
...
export default function MagazineStock() {
  ...
  const handleUpdate = async (payload) => {
    await stockAPI.update(payload.id, payload);
        ...
        <header style={{ background: "#1C1917", padding: "1.25rem 1.25rem 1rem", position: "sticky", top: 0, zIndex: 30 }}>
          <div style={{ maxWidth: 640, margin: "0 auto" }}>
            <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: "0.9rem" }}>
              <div>
                <p style={{ fontFamily: "'DM Sans', sans-serif", fontSize: "0.68rem", fontWeight: 700, textTransform: "uppercase", letterSpacing: "0.12em", color: "#D97706", marginBottom: "0.15rem" }}>
                  📦 Magazine ·
                </p>
              ...
              <button
                ...
                style={{ background: "#D97706", border: "none", borderRadius: "0.85rem", color: "#fff", fontFamily: "'DM Sans', sans-serif", fontWeight: 700, fontSize: "0.88rem", padding: "0.65rem 1.1rem", cursor: "pointer", display: "flex", alignItems: "center", gap: "0.3rem", boxShadow: "0 4px 12px rgba(217,119,6,0.4)" }}
              >+ Shto</button>
            </div>
